...
class PostboxException extends FlowCatalystException
{
    /**
    ...
    /**
     * Create an exception for postbox not enabled.
     */
    public static function notEnabled(): static
    {
        return new static('Postbox is not enabled. Set FLOWCATALYST_POSTBOX_ENABLED=true in your environment.');
    }
    ...
    {
        return new static("Postbox driver '{$driver}' is not supported. Supported drivers: database, mongodb.");
    }
    ...
    {
        return new static("Failed to insert postbox message: {$reason}");
    }

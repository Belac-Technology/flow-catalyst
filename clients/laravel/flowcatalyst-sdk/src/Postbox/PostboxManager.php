...
namespace FlowCatalyst\Postbox;
...
class PostboxManager
{
    public function __construct(
        private readonly PostboxDriver $driver,
        private readonly int $tenantId,
        private readonly string $defaultPartition = 'default'
    ) {}

    /**
     * Create an event in the postbox.
     *
    ...
    /**
     * Create a dispatch job in the postbox.
     *
     * @return string The generated message ID (TSID)
     * @throws PostboxException
     */
    ...
    /**
     * Create multiple events in the postbox (batch).
     *
    ...
    /**
     * Create multiple dispatch jobs in the postbox (batch).
     *
     ...
     */
    public function driver(): PostboxDriver
    {
        return $this->driver;
    }
    ...
    {
        if ($this->tenantId <= 0) {
            throw PostboxException::missingTenantId();
        }
    }
}

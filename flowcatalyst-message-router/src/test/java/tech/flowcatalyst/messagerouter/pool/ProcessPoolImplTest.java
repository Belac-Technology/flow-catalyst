...
class ProcessPoolImplTest {
    ...
    void shouldRejectMessageWhenQueueFull() {
        ...
        // Give time for message1 to start processing and message2 to be queued
        // Wait 30ms (must be less than mediator's 100ms block time)
        // This ensures queue is full but message1 hasn't completed yet

...
public class TestPermissionRegistryInitializer {
    ...
    void onStart(@Observes @Priority(100) StartupEvent event) {
        ...
        registry.registerPermission(PlatformTenantUserViewTestPermission.INSTANCE);
        registry.registerPermission(PlatformTenantUserCreateTestPermission.INSTANCE);
        registry.registerPermission(PlatformTenantManageTestPermission.INSTANCE);
        ...
        registry.registerRole(PlatformTestTenantAdminRole.INSTANCE);

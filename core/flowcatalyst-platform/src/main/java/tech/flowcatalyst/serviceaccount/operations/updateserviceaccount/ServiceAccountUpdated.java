...
public record ServiceAccountUpdated(
    ...
    public static class Builder {
        ...
        private String serviceAccountId, code, name, description;
        ...
        public ServiceAccountUpdated build() {
            return new ServiceAccountUpdated(eventId, time, executionId, correlationId, causationId, principalId,
                serviceAccountId, code, name, description);
        }
    }
}

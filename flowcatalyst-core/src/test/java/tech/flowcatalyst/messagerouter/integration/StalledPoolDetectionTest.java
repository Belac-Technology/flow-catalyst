...
class StalledPoolDetectionTest {
    ...
    void shouldHandleExactTimeoutBoundary() {
        // Given - pool at exactly 2 minutes (120 seconds = 120,000 ms)
        long exactTimeoutTimestamp = System.currentTimeMillis() - 120_000;
        ...
        // Then - should be healthy (timeout is > 120s, not >=)
        assertTrue(health.healthy());
        assertNull(health.issues());
    }
